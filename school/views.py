...
#for showing signup/login button for teacher(by Pradumn)
...
#for showing signup/login button for student(by Pradumn)
...
#for checking user is techer , student or admin(by Pradumn)
def is_admin(user):
...
#for dashboard of adminnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn(by Pradumn)
...
def admin_dashboard_view(request):
    ...
    #aggregate function return dictionary so fetch data from dictionay(by Pradumn)
    mydict={
...
#for teacher sectionnnnnnnn by adminnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn(by Pradumn)
...
#for student by adminnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn(by Pradumn)
...
#attendance related viewwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(by Pradumn)
@login_required(login_url='adminlogin')
@user_passes_test(is_admin)
...
#fee related view by adminnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn(by Pradumn)
@login_required(login_url='adminlogin')
@user_passes_test(is_admin)
...
#notice related viewsssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss(by Pradumn)
@login_required(login_url='adminlogin')
@user_passes_test(is_admin)
...
#for TEACHER  LOGIN    SECTIONNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN(by Pradumn)
...
#FOR STUDENT AFTER THEIR Loginnnnnnnnnnnnnnnnnnnnn(by Pradumn)
...
# for aboutus and contact ussssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss (by Pradumn)
